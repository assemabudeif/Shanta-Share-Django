...
# from django.contrib.auth.core_models import User
# from .core_models import Client, Driver
# from .core_models import Client, ClientPhoneNumber
# from rest_framework import serializers
# from .core_models import Driver
# from .core_models import DriverLicense
# from .core_models import DriverLicense
# from .core_models import Driver, DriverPhoneNumber, Car, CarImage, CarLicense, NationalityID
#
